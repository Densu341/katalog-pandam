...
<head>
  ...
  <link href="<?php echo base_url('assets/fontawesome-free-5/css/all.min.css'); ?>" rel="stylesheet" type="text/css">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
        <div class="sidebar-brand-icon rotate-n-0">
          <img src="<?= base_url() ?>assets/favicon.png" alt="" height="50">
        </div>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header"><?php echo $this->session->userdata('role'); ?> Menu</h6>
      ...
      <?php if ($this->session->userdata('role') === 'administrator') { ?>
        ...
        <li class="nav-item">
          <a class="nav-link" href="<?= base_url() ?>dashboard/editprofile">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <img src="<?= base_url() ?>assets/img/profile/<?= $user['image']; ?>" class="img-profile rounded-circle" alt="profile picture">
              </a>
              <!-- Dropdown - User Information -->
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                <a class="dropdown-item" href="<?= base_url() ?>dashboard/editprofile">
